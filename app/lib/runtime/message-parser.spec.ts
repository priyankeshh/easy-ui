...
describe('StreamingMessageParser', () => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <boltArtifacs></easyuiArtifact>', 'Foo bar <boltArtifacs></easyuiArtifact>'],
      ['Before <oltArtfiact>foo</easyuiArtifact> After', 'Before <oltArtfiact>foo</easyuiArtifact> After'],
      ['Before <easyuiArtifactt>foo</easyuiArtifact> After', 'Before <easyuiArtifactt>foo</easyuiArtifact> After'],
    ])('should correctly parse chunks and strip out bolt artifacts (%#)', (input, expected) => {
      runTest(input, expected);
    });
  });
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <easyuiArtifact title="Some title" id="artifact_1">foo bar</easyuiArtifact> Some more text',
        {
      ...
      [
        [
          ...
          'fact',
          ' title="Some title" id="artifact_1" type="bundled" >foo</easyuiArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' ',
          '>',
          'foo</easyuiArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' >fo',
          'o</easyuiArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <easyuiArtifact title="Some title" id="artifact_1">foo</easyuiArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <easyuiArtifact title="Some title" id="artifact_1"><easyuiAction type="shell">npm install</easyuiAction></easyuiArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <easyuiArtifact title="Some title" id="artifact_1"><easyuiAction type="shell">npm install</easyuiAction><easyuiAction type="file" filePath="index.js">some content</easyuiAction></easyuiArtifact> After',
        {
          output: 'Before  After',
