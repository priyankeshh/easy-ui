  ...
  return (
    <AnimatePresence>
      ...
      >
        <div
          className={classNames(
            'bg-easyui-elements-item-backgroundAccent',
            'p-1 rounded-lg text-easyui-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-easyui-elements-item-backgroundAccent hover:bg-easyui-elements-artifacts-backgroundHover"
