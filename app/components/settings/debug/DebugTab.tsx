  ...
  return (
    <div className="p-4 space-y-6">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-medium text-easyui-elements-textPrimary">Debug Information</h3>
        <div className="flex gap-2">
          <button
            onClick={handleCopyToClipboard}
            className="bg-easyui-elements-button-primary-background rounded-lg px-4 py-2 transition-colors duration-200 hover:bg-easyui-elements-button-primary-backgroundHover text-easyui-elements-button-primary-text"
          >
            Copy Debug Info
          </button>
          <button
            ...
            className={`bg-easyui-elements-button-primary-background rounded-lg px-4 py-2 transition-colors duration-200
              ${!isCheckingUpdate ? 'hover:bg-easyui-elements-button-primary-backgroundHover' : 'opacity-75 cursor-not-allowed'}
      ...
      {updateMessage && (
        <div
          className={`bg-easyui-elements-surface rounded-lg p-3 ${
            updateMessage.includes('Update available') ? 'border-l-4 border-yellow-400' : ''
          }`}
        >
          <p className="text-easyui-elements-textSecondary whitespace-pre-line">{updateMessage}</p>
          {updateMessage.includes('Update available') && (
            <div className="mt-3 text-sm">
              <p className="font-medium text-easyui-elements-textPrimary">To update:</p>
              <ol className="list-decimal ml-4 mt-1 text-easyui-elements-textSecondary">
                <li>
                  Pull the latest changes:{' '}
                  <code className="bg-easyui-elements-surface-hover px-1 rounded">git pull upstream main</code>
                </li>
                <li>
                  Install any new dependencies:{' '}
                  <code className="bg-easyui-elements-surface-hover px-1 rounded">pnpm install</code>
                </li>
      ...
      <section className="space-y-4">
        <div>
          <h4 className="text-md font-medium text-easyui-elements-textPrimary mb-2">System Information</h4>
          <div className="bg-easyui-elements-surface rounded-lg p-4">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              <div>
                <p className="text-xs text-easyui-elements-textSecondary">Operating System</p>
                <p className="text-sm font-medium text-easyui-elements-textPrimary">{systemInfo.os}</p>
              </div>
              <div>
                <p className="text-xs text-easyui-elements-textSecondary">Device Type</p>
                <p className="text-sm font-medium text-easyui-elements-textPrimary">{systemInfo.deviceType}</p>
              </div>
              <div>
                <p className="text-xs text-easyui-elements-textSecondary">Browser</p>
                <p className="text-sm font-medium text-easyui-elements-textPrimary">{systemInfo.browser}</p>
              </div>
              <div>
                <p className="text-xs text-easyui-elements-textSecondary">Display</p>
                <p className="text-sm font-medium text-easyui-elements-textPrimary">
                  {systemInfo.screen} ({systemInfo.colorDepth}) @{systemInfo.pixelRatio}x
                </p>
              </div>
              <div>
                <p className="text-xs text-easyui-elements-textSecondary">Connection</p>
              ...
              <div>
                <p className="text-xs text-easyui-elements-textSecondary">Screen Resolution</p>
                <p className="text-sm font-medium text-easyui-elements-textPrimary">{systemInfo.screen}</p>
              </div>
              <div>
                <p className="text-xs text-easyui-elements-textSecondary">Language</p>
                <p className="text-sm font-medium text-easyui-elements-textPrimary">{systemInfo.language}</p>
              </div>
              <div>
                <p className="text-xs text-easyui-elements-textSecondary">Timezone</p>
                <p className="text-sm font-medium text-easyui-elements-textPrimary">{systemInfo.timezone}</p>
              </div>
              <div>
                <p className="text-xs text-easyui-elements-textSecondary">CPU Cores</p>
                <p className="text-sm font-medium text-easyui-elements-textPrimary">{systemInfo.cores}</p>
              </div>
            </div>
            <div className="mt-3 pt-3 border-t border-easyui-elements-surface-hover">
              <p className="text-xs text-easyui-elements-textSecondary">Version</p>
              <p className="text-sm font-medium text-easyui-elements-textPrimary font-mono">
                {connitJson.commit.slice(0, 7)}
                <span className="ml-2 text-xs text-easyui-elements-textSecondary">
        ...
        <div>
          <h4 className="text-md font-medium text-easyui-elements-textPrimary mb-2">Local LLM Status</h4>
          <div className="bg-easyui-elements-surface rounded-lg">
            <div className="grid grid-cols-1 divide-y">
                ...
                <div key={provider.name} className="p-3 flex flex-col space-y-2">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-easyui-elements-textPrimary">{provider.name}</p>
                        {provider.url && (
                          <p className="text-xs text-easyui-elements-textSecondary truncate max-w-[300px]">
                            {provider.url}
                          </p>
                        )}
                      </div>
                  ...
                  <div className="pl-5 flex flex-col space-y-1 text-xs">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <span className="text-easyui-elements-textSecondary">
                    ...
                    {/* Connection Info */}
                    {provider.url && (
                      <div className="text-easyui-elements-textSecondary">
              ...
              {activeProviders.length === 0 && (
                <div className="p-4 text-center text-easyui-elements-textSecondary">No local LLMs configured</div>
              )}
            </div>
          </div>
        </div>
