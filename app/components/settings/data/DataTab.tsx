...
export default function DataTab() {
  ...
  return (
    <div className="p-4 bg-easyui-elements-bg-depth-2 border border-easyui-elements-borderColor rounded-lg mb-4">
      <div className="mb-6">
        <h3 className="text-lg font-medium text-easyui-elements-textPrimary mb-4">Data Management</h3>
        <div className="space-y-8">
          <div className="flex flex-col gap-4">
            <div>
              <h4 className="text-easyui-elements-textPrimary mb-2">Chat History</h4>
              <p className="text-sm text-easyui-elements-textSecondary mb-4">Export or delete all your chat history.</p>
              <div className="flex gap-4">
                <button
                  onClick={handleExportAllChats}
                  className="px-4 py-2 bg-easyui-elements-button-primary-background hover:bg-easyui-elements-button-primary-backgroundHover text-easyui-elements-textPrimary rounded-lg transition-colors"
                >
                  Export All Chats
                </button>
                <button
                ...
                <button
                  ...
                  className={classNames(
                    'px-4 py-2 bg-easyui-elements-button-danger-background hover:bg-easyui-elements-button-danger-backgroundHover text-easyui-elements-button-danger-text rounded-lg transition-colors',
            ...
            <div>
              <h4 className="text-easyui-elements-textPrimary mb-2">Settings Backup</h4>
              <p className="text-sm text-easyui-elements-textSecondary mb-4">
              ...
              <div className="flex gap-4">
                ...
                <label className="px-4 py-2 bg-easyui-elements-button-primary-background hover:bg-easyui-elements-button-primary-backgroundHover text-easyui-elements-textPrimary rounded-lg transition-colors cursor-pointer">
                  Import Settings
            ...
            <div>
              <h4 className="text-easyui-elements-textPrimary mb-2">API Keys Management</h4>
              <p className="text-sm text-easyui-elements-textSecondary mb-4">
