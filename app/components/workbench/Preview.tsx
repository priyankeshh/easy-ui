...
export const Preview = memo(() => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-easyui-elements-background-depth-2 p-2 flex items-center gap-2">
        <div className="flex items-center gap-2">
          <IconButton icon="i-ph:arrow-clockwise" onClick={reloadPreview} />
          <IconButton
            icon="i-ph:selection"
            onClick={() => setIsSelectionMode(!isSelectionMode)}
            className={isSelectionMode ? 'bg-easyui-elements-background-depth-3' : ''}
          />
        </div>

        <div className="flex-grow flex items-center gap-1 bg-easyui-elements-preview-addressBar-background border border-easyui-elements-borderColor text-easyui-elements-preview-addressBar-text rounded-full px-3 py-1 text-sm hover:bg-easyui-elements-preview-addressBar-backgroundHover hover:focus-within:bg-easyui-elements-preview-addressBar-backgroundActive focus-within:bg-easyui-elements-preview-addressBar-backgroundActive focus-within-border-easyui-elements-borderColorActive focus-within:text-easyui-elements-preview-addressBar-textActive">
          <input
            title="URL"
            ref={inputRef}
      ...
      <div className="flex-1 border-t border-easyui-elements-borderColor flex justify-center items-center overflow-auto">
        <div
          style={{
            width: isDeviceModeOn ? `${widthPercent}%` : '100%',
            height: '100%',
            overflow: 'visible',
            background: 'var(--easyui-elements-background-depth-1)',
            position: 'relative',
            display: 'flex',
          }}
        >
          {activePreview ? (
            <>
              <iframe
                ref={iframeRef}
                title="preview"
                className="border-none w-full h-full bg-easyui-elements-background-depth-1"
                src={iframeUrl}
            ...
            <div className="flex w-full h-full justify-center items-center bg-easyui-elements-background-depth-1 text-easyui-elements-textPrimary">
