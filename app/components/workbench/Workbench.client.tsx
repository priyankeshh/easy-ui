      ...
      >
        ...
        >
          <div className="absolute inset-0 px-2 lg:px-6">
            <div className="h-full flex flex-col bg-easyui-elements-background-depth-2 border border-easyui-elements-borderColor shadow-sm rounded-lg overflow-hidden">
              <div className="flex items-center px-3 py-2 border-b border-easyui-elements-borderColor">
